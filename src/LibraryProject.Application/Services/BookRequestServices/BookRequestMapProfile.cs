    ...
    public class BookRequestMapProfile : Profile 
    {
        ...
        public BookRequestMapProfile()
        {
            ...
            CreateMap<BookRequest, BookRequestDto>()
                ...
                .ForMember(dest => dest.RequestorId, m => m.MapFrom(src => src.Person != null ? src.Person.Id : (Guid?)null))
                .ForMember(dest => dest.RequestDate, m => m.MapFrom(src => src.BookRequestDate != null ? src.BookRequestDate : (DateTime?)null))
                .ForMember(dest => dest.ReturnDate, m => m.MapFrom(src => src.BookReturnDate != null ? src.BookReturnDate : (DateTime?)null))
                .ForMember(dest => dest.ReleasorId, m => m.MapFrom(src => src.ReleasedBy != null ? src.ReleasedBy.Id:(Guid?)null));
        }
